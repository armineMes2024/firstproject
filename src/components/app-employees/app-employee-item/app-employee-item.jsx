...
// 		const { name, salary, increase, onToggleIncrease } = this.props

// 		return (
// 			<div className={`app-employee-item ${increase ? 'increased' : ''}`}>
// 				<h4 className='employee-name' onClick={this.toggleIcon}>
// 					{name}
// 				</h4>
// 				<input
// 					type='text'
...
export default class AppEmployeeItem extends Component {
	render() {
		...
		return (
			<div className={classes}>
				<h4 onClick={onToggleRise} className='employee-name'>
					{name}
				</h4>
				<input
					type='text'
